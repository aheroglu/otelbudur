        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentFor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailsSents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactAnswer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContactAnswer_Contacts_ContactId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuestThoughts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GuestThoughts_Guests_GuestId",
                        column: x => x.GuestId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelOwnerRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelOwnerRequests_Locations_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReserveBeginning = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReserveEnding = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactAnswer_ContactId",
                table: "ContactAnswer",
                column: "ContactId");

            migrationBuilder.CreateIndex(
                name: "IX_GuestThoughts_GuestId",
                table: "GuestThoughts",
                column: "GuestId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelOwnerRequests_LocationId",
                table: "HotelOwnerRequests",
                column: "LocationId");
