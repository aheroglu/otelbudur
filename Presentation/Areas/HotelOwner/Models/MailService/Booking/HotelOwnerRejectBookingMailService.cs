...
{
    public class HotelOwnerRejectBookingMailService
    {
        public void SendMessage(string fullName, string email)
        {
            ...
            bodyBuilder.HtmlBody = $"<p>Dear {fullName},</p> <p>Your booking was rejected.</p> <p>Reservation Status: <span style='color: #fa0000;'>Rejected</span></p>";
